...
<div id="content-wrapper" class="d-flex flex-column">
    <div class="container-fluid">
        <div id="contentPanel" style="position:absolute; left:225px;">
            <h1>Truck List <i class="fa fa-truck" style="font-size:48px;color:blue"></i>
                <a class="btn btn-primary" style="text-align: right;margin-left: 600px"
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${trucks}" var="truck">
                        <tr>
                            ...
                            <td><a href="<c:url value='./removeTruck/${truck.id}' />"><i class='fas fa-times'
                                                                                         id='deleteTruckImg'></i></a>
                            </td>
